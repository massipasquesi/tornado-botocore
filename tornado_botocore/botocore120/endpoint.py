...
from botocore120.vendored.requests.sessions import Session
from botocore120.vendored.requests.utils import get_environ_proxies
from botocore120.vendored.requests.exceptions import ConnectionError
from botocore120.vendored import six

from botocore120.awsrequest import create_request_object
from botocore120.exceptions import BaseEndpointResolverError
from botocore120.exceptions import EndpointConnectionError
from botocore120.compat import filter_ssl_warnings
from botocore120.utils import is_valid_endpoint_url
from botocore120.hooks import first_non_none_response
from botocore120.response import StreamingBody
from botocore120 import parsers
...
def convert_to_response_dict(http_response, operation_model):
    ...
    :type http_response: botocore120.vendored.requests.model.Response
