...
from botocore120.compat import total_seconds
from botocore120.exceptions import UnknownCredentialError
from botocore120.exceptions import PartialCredentialsError
from botocore120.exceptions import ConfigNotFound
from botocore120.utils import InstanceMetadataFetcher, parse_key_val_file
...
class SharedCredentialProvider(CredentialProvider):
    ...
    def __init__(self, creds_filename, profile_name=None, ini_parser=None):
        ...
        if ini_parser is None:
            ini_parser = botocore120.config.raw_config_parse
...
class ConfigProvider(CredentialProvider):
    ...
    def __init__(self, config_filename, profile_name, config_parser=None):
        ...
        if config_parser is None:
            config_parser = botocore120.config.load_config
