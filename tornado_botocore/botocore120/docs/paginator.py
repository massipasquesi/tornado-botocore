...
from botocore120 import xform_name
from botocore120.compat import OrderedDict
from botocore120.docs.utils import DocumentedShape
from botocore120.docs.method import document_model_driven_method
...
class PaginatorDocumenter(object):
    ...
    def _add_paginate_method(self, section, paginator_name):
        ...
        # These are parameters we expose via the botocore120 interface.
        ...
        botocore120_pagination_response_params = [
            DocumentedShape(
        ...
        document_model_driven_method(
            ...
            include_input=botocore120_pagination_params,
            include_output=botocore120_pagination_response_params,
