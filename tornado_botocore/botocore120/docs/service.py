...
from botocore120.docs.utils import get_official_service_name
from botocore120.docs.client import ClientDocumenter
from botocore120.docs.waiter import WaiterDocumenter
from botocore120.docs.paginator import PaginatorDocumenter
from botocore120.docs.bcdoc.restdoc import DocumentStructure


class ServiceDocumenter(object):
    def __init__(self, service_name):
        self._session = botocore120.session.get_session()
