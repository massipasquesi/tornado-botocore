...
from botocore120.exceptions import InvalidExpressionError, ConfigNotFound
from botocore120.compat import json, quote, zip_longest, urlsplit, urlunsplit
from botocore120.vendored import requests
...
class ArgumentGenerator(object):
    ...
    an input shape (created from ``botocore120.model``) and generate
    ...
    Example usage::
        ...
        s = botocore120.session.get_session()
    ...
    def generate_skeleton(self, shape):
        ...
        :type shape: ``botocore120.model.Shape``
