...
by botocore120.  This can include:
...
to import, the botocore120 loaders have the concept of a data path exposed
...
from botocore120 import BOTOCORE_ROOT
from botocore120.compat import json
from botocore120.compat import OrderedDict
from botocore120.exceptions import DataNotFoundError
...
class Loader(object):
    ...
    # The included models in botocore120/data/ that we ship with botocore120.
    ...
    def load_service_model(self, service_name, type_name, api_version=None):
        """Load a botocore120 service model

        This is the main method for loading botocore120 models (e.g. a service
