...
def create_waiter_with_client(waiter_name, waiter_model, client):
    ...
    :type waiter_model: botocore120.waiter.WaiterModel
    :param waiter_model: The model for the waiter configuration.

    :type client: botocore120.client.BaseClient
    :param client: The botocore120 client associated with the service.

    :rtype: botocore120.waiter.Waiter
...
class WaiterModel(object):
    ...
    def __init__(self, waiter_config):
        ...
        :param waiter_config: The loaded waiter config
            ...
            obtained from a botocore120 Loader object as well.
...
class Waiter(object):
    def __init__(self, name, config, operation_method):
        ...
        :type config: botocore120.waiter.SingleWaiterConfig
        ...
        :param operation_method: A callable that accepts **kwargs
            ...
            a method from a botocore120 client.
