...
"""
This module contains the main interface to the botocore120 package, the
Session object.
"""
...
from botocore120 import __version__
import botocore120.config
import botocore120.credentials
import botocore120.client
from botocore120.exceptions import ConfigNotFound, ProfileNotFound
from botocore120 import handlers
from botocore120.hooks import HierarchicalEmitter, first_non_none_response
from botocore120.loaders import create_loader
from botocore120.parsers import ResponseParserFactory
from botocore120 import regions
from botocore120.model import ServiceModel
from botocore120 import paginate
from botocore120 import waiter
from botocore120 import retryhandler, translate


class Session(object):
    """
    The Session object collects together useful functionality
    from `botocore120` as well as important data such as configuration
    ...
    #: ``get_config_variable`` method of the :class:`botocore120.session.Session`
    #: class.
    ...
    #: The default format string to use when configuring the botocore120 logger.
    ...
    def _register_credential_provider(self):
        self._components.lazy_register_component(
            'credential_provider',
            lambda:  botocore120.credentials.create_credential_resolver(self))
        ...
        **entire** config file.
        ...
        if self._config is None:
            try:
                ...
                self._config = botocore120.config.load_config(config_file)
            ...
            try:
                ...
                cred_profiles = botocore120.config.raw_config_parse(cred_file)
    ...
    def set_credentials(self, access_key, secret_key, token=None):
        ...
        prefer to use botocore120 without a config file, environment variables,
        ...
        :param token: An option session token used by STS session
            credentials.
        """
        self._credentials = botocore120.credentials.Credentials(access_key,
                                                             secret_key,
                                                             token)

    def get_credentials(self):
        """
        Return the :class:`botocore120.credential.Credential` object
    ...
    def user_agent(self):
        ...
        Where:
         ...
         - agent_version is the value of the `user_agent_version`
           attribute of the session object (the botocore120 version by default).
           by default.
    ...
    def get_service_model(self, service_name, api_version=None):
        ...
        :rtype: L{botocore120.model.ServiceModel}
        :return: The botocore120 service model for the service.
    ...
    def set_debug_logger(self, logger_name='botocore120'):
        """
    ...
    def set_file_logger(self, log_level, path, logger_name='botocore120'):
        """
    ...
    def create_client(self, service_name, region_name=None, api_version=None,
        ...
        :type api_version: string
        :param api_version: The API version to use.  By default, botocore120 will
        ...
        :param verify: Whether or not to verify SSL certificates.
            ...
            * path/to/cert/bundle.pem - A filename of the CA cert bundle to
              ...
              different CA cert bundle than the one used by botocore120.

        :type endpoint_url: string
        :param endpoint_url: The complete URL to use for the constructed
            client.  Normally, botocore120 will automatically construct the
        ...
        :type config: botocore120.client.Config
        ...
        :rtype: botocore120.client.BaseClient
        :return: A botocore120 client instance
        ...
        if aws_secret_access_key is not None:
            credentials = botocore120.credentials.Credentials(
        ...
        client_creator = botocore120.client.ClientCreator(
