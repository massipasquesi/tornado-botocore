...
from botocore120.vendored.requests import ConnectionError, Timeout
from botocore120.vendored.requests.packages.urllib3.exceptions import ClosedPoolError

from botocore120.exceptions import ChecksumError, EndpointConnectionError
