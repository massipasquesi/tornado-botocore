...
from botocore120 import ScalarTypes
from botocore120.hooks import first_non_none_response
from botocore120.compat import json, set_socket_timeout, XMLParseError
from botocore120.exceptions import IncompleteReadError
...
class StreamingBody(object):
    ...
    def set_socket_timeout(self, timeout):
        ...
        try:
            ...
            # in py2 and py3.  So this code has been pushed to botocore120.compat.
