...
from botocore120.compat import six
from botocore120.compat import HTTPHeaders, HTTPResponse, urlunsplit, urlsplit
from botocore120.exceptions import UnseekableStreamError
from botocore120.utils import percent_encode_sequence
from botocore120.vendored.requests import models
from botocore120.vendored.requests.sessions import REDIRECT_STATI
from botocore120.vendored.requests.packages.urllib3.connection import \
    VerifiedHTTPSConnection
from botocore120.vendored.requests.packages.urllib3.connection import \
    HTTPConnection
from botocore120.vendored.requests.packages.urllib3.connectionpool import \
    HTTPConnectionPool
from botocore120.vendored.requests.packages.urllib3.connectionpool import \
    HTTPSConnectionPool
...
class AWSHTTPConnection(HTTPConnection):
    ...
    tentative and keeping it in botocore120 because I've only tested
...
def create_request_object(request_dict):
    ...
    :rtype: ``botocore120.awsrequest.AWSRequest``
