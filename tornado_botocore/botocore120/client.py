...
import botocore120.serialize
import botocore120.validate
from botocore120 import waiter, xform_name
from botocore120.awsrequest import prepare_request_dict
from botocore120.endpoint import EndpointCreator, DEFAULT_TIMEOUT
from botocore120.exceptions import ClientError, DataNotFoundError
from botocore120.exceptions import OperationNotPageableError
from botocore120.hooks import first_non_none_response
from botocore120.model import ServiceModel
from botocore120.paginate import Paginator
from botocore120.signers import RequestSigner
from botocore120.utils import CachedProperty
from botocore120.docs.method import LazyLoadedDocstring
...
class ClientCreator(object):
    ...
    def _get_client_args(self, service_model, region_name, is_secure,
        ...
        serializer = botocore120.serialize.create_serializer(
            protocol, include_validation=True)

        event_emitter = copy.copy(self._event_emitter)

        response_parser = botocore120.parsers.create_parser(protocol)
...
class BaseClient(object):
    ...
    def get_paginator(self, operation_name):
        ...
        :rtype: L{botocore120.paginate.Paginator}
